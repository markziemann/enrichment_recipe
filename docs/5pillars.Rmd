...
Using a literate script would mean only minimal changes are required between interations @Perkel2022-af.
...
it helps the reader understand the logical steps taken in an analysis.
...
repository, means the code can be easily recovered if any one of those computers fail.
...
![Figure 4. Architecture of containers (left) compared to virtual machines (right) @noauthor_2021-lt](../img/docker-containerized-and-vm-transparent-bg.webp)
...
used in an article to a suitable persitent long-term archive (discussed below).
The recipe used to build the Docker image, called the Dockerfile, is sufficiently small and can be added
to the project repository.

## FAIR and persistent data sharing

FAIR data sharing is one of the key features of open science, which characterises itself as science
that is collaborative, transparent, accessible and inclusive [@noauthor_2023-uq].

The Universal Declaration of Human Rights states [@United_Nations1948-ua]:

>Everyone has the right freely to participate in the cultural life of the
>community, to enjoy the arts and to share in scientific advancement and
>its benefits.

In this context, access to research data may be interpreted as a benefit of scientific advancement.
In particular, when large data sets are generated with public funds, the public might expect that the
benefts of that study, like the publications and underlying data are released.

Data sharing has dual purposes, firstly this data may be useful in answering other research questions,
and secondly to facilitate reproduction and auditing [@Wilkinson2016-qq].
Data reuse prevents redundant research and facilitates new research ideas that were impossible without
it.
In terms of research rigour, inspecting raw data can uncover research integrity problems [@Miyakawa2020-yj],
in addition to validation of scientific findings by independent computational reproduction [@Ioannidis2009-hv].
In light of this, a research article without supporting data and code is much like a press release or
advertisement and the claims made cannot be verified as true or not.

Although it is common to see journal articles with "Data available upon reasonable request", this is less
than ideal.
I, and many fellow researchers have had the displeasure of attempting to contact corresponding
authors of these studies and learn that they have moved on to another institute, retired, passed away,
or the data has been lost or otherwise unavailable (if they receive a response at all).
In the rare cases that the data has been retained, arranging access can be tedious as such datasets can
run into hundreds of gigabytes which cannot be easily transferred across the internet.
If many requests are made for a dataset, this can become time intensive for the sharers which is
wasteful considering they could have shared the data from the start and reached a larger audience.




FAIR principles: @Wilkinson2016-qq

Long term data archiving (and sharing) not only faciliitates this,


Using secondary data is 
...
Use webarchive to archive important resources.
...
This work is not designed to give strong recommendations on the exact combination of tools or resources
...
When these five considerations are addressed, they facilitate extreme reproducibility, ie: makes
reproduction relatively quick, and simple.
For example, we made a transcriptome analysis workflow based on the five pillars approach and
it could could be installed and generate differential expression and pathway enrichment results in a
matter of minutes with only a few commands @Ziemann_undated-zx.
...
found that environment problems (eg: "module not found", "import error") and lack of data links
(eg: "file not found" errors) accounted for 80% of code errors @Samuel2022-ha.
...
Some researchers have suggested to take it even further, by adapting software development
...
Therefore continuous analysis might be a future pediment (crowning feature) to the five-pillared
...
(eg: [@Ioannidis2009-hv; @Samuel2022-ha]), so we don't have much of a grasp as to how severe the problem
actually is.
...
For example, my group has just released such a protocol that walks novice users through the process
...
coordinate those hybrid computate workflows.
