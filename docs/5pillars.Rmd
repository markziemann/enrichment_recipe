...
These innovations, when brought together facilitate extreme reproducibility, ie: makes reproducing a previous study relatively
easy in terms of complexity, number of commands, and in time.
For example, we made an example transcriptome analysis workflow based on the five pillars approach and it could could be installed
and generate differential expression and pathway enrichment results in a matter of minutes.
