...
to running directly on the host system @Di_Tommaso2015.
...
Some researchers have suggested to take it even further, by adopting the software development
principles of unit tests and continuous integration/continuous delivery into the research process.
By doing this, the entire project workflow is automatically executed and checked whenever a change is
...
With the above innovations, it's possible to reproduce a computational study with just a few
