---
title: "The five pillars of computational reproducibility: A bioinformatics perspective"
author: "Mark Ziemann"
date: "`r Sys.Date()`"
output:
  rmdformats::robobook:
...
![Figure 5. Overview of the FAIR data principles @Kalendralis2021-jb](../img/gr2)
...
proceduce called "pathway analysis".
...
So in order to guarantee future reproducibility, shapshots of those reference data should be archived &
shared if the licence permits it.
...
Due to the rapidly devloping software landscape, this work is not designed to give strong
...
https://www.researchgate.net/publication/349603799_Making_radiotherapy_more_efficient_with_FAIR_data/figures?lo=1

Maer-Matei, Monica Mihaela, Tiberiu Marian Georgescu, Cristina Mocanu, and Ana-Maria Zamfir. 2019/01/01////.
“Skill Needs for Early Career Researchers.” Sustainability 11 (10). https://doi.org/ghkb9m (https://doi.org/ghkb9m).
