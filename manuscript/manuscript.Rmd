...
[Anusuiya Bora<sup>2</sup>](https://orcid.org/0009-0006-2908-1352)
...
reproducibility.
The findings indicate that current enrichment analysis practices and reporting are inadequate.
...
This recipe is built according to the "five pillars" framework, which facilitates extreme
reproducibility.
...
Literate programming using R Markdown or Jupyter notebooks provides optimal documentation by embedding
...
Taken together, computational reproducibility is a spectrum @Akalin2018-eg, and the *five pillars*
framework has been described as a way of achieving extreme reproducibility @Ziemann2023-pt.
...
As of August 2020, this type of analysis was cited in 131,332 articles [@Xie2021-ch], illustrating
how crucial these tools are in the interpretation of omics data.
Moreover, analysis of related keywords in PubMed suggests the number of articles describing
"enrichment analysis" is doubling every two years, as omics analysis becomes accessible to
more researchers around the world.

While enrichment analysis is undoubtedly a key method for the interpretation of large omics
...
The reliability of enrichment analysis results would benefit by adopting best practices in computational
research.
...
This protocol is in accordance with the *five pillars*, and includes
...
analysis: over-representation analysis (ORA) and functional class scoring (FCS) (**Figure 2**).

```{r,diagram,echo=FALSE,fig.cap = "Figure 2. Flow chart of example workflow."}
...
Reproducing this workflow is relatively quick and simple, requiring six commands and approximately four
...
groups, suggesting a robust effect of the chemical treatment (**Figure 3A**).
...
![Figure 3. Differential expression and enrichment analysis with the example workflow.
...
those in grey indicate did not meet this threshold.
...
transport and defective homologous recombination repair (**Figure 3D**).
...
Users provide a list of genes in a text box and select some options.
There are several posible explanations for this inconsistency:
...
rigorous and reproducible methods, such as this protocol.

Significant progress is being made to make such point-and-click tools more reproducible.
...
Such functionality could be written into existing enrichment analysis tools like DAVID, and
could provide a "good enough" solution to reproducibility.
...
* Protocol: can be found at protocols.io @Ziemann2023-kz.

* Code repository including template Dockerfile and R Markdown script: https://github.com/markziemann/enrichment_recipe
