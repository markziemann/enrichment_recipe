---
title: "Tackling irreproducible pathway enrichment analysis"
date: "`r Sys.Date()`"
output:
  rmdformats::robobook:
  html_document:
...
Previous work has highlighted that published pathway enrichment analyses frequently suffer from
statistical and reporting flaws.
...
discrepancies.
These inconsistencies can mostly be ascribed to deficiencies in methodological reporting and lack of
preservation of past DAVID versions.
Better reporting and a long-term view of reproducibility are needed.
Scripted workflows and shared code are a potential solution to this problem, although there is a
steep learning curve for novice analysts.
We provide a step-by-step beginner-friendly enrichment analysis protocol
exemplifying current best practices including literate programming, version control, containerisation,
documentation and persistent sharing of data and code.
...
Functional enrichment analysis is one of the most frequently used methods in
...
(ii) lack of p-value correction for multiple testing and (iii) general lack of reporting detail
...
the validity of the methods and results [@Sandve2013-lk].

To determine whether web based enrichment analysis is reproducible, here we systematically examine the
reproducibilty of DAVID enrichment analysis in 20 published articles, investigate root causes of
reproduction failure and describe some potential solutions.
...
For example, less than 50% of GO and/or KEGG terms mentioned in the results and discussion were confirmed
...
information about how the enrichment analysis was done and present in Table 1.
...
low and mid-tier journals (mean SJR 2022: 1.2, SD=0.68) and the results may not be representative of
...
Furthermore, our reproducibility assessment is based on "head-counting" pathways that meet an arbitrary significance threshold.
This binary classification of results is less powerful as opposed to comparison of standardised effect sizes.
