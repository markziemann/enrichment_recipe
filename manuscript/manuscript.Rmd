...
for each part sequentially, making the entire manuscript reproducible by executing just one command
...
```{r,barchart,fig.width=6,fig.height=5,echo=FALSE,fig.cap = "Figure 1. Examining reproducibility in a sample of 20 journal articles."}
...
This protocol is in accordance with the *five pillars* including
...
With ORA, we observed 201 up-regulated and 99 down-regulated gene sets.
...
After FCS, we identified 239 up-regulated gene sets and 158 down-regulated gene sets.
...
Down-regulated pathways related to endosomal/lysosome pathway, interferon signaling and TLR/TNF
signaling.
...
![Figure 3. Differential expression and enrichment analysis with the example workflow.](../img/fig_example.png "Example enrichment analysis on")
