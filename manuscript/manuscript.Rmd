...
To determine whether web based enrichment analysis is reproducible, we systematically examine the
reproducibilty of DAVID enrichment analysis in 20 published articles.
...
sections of the 20 articles using DAVID version 6.8 (conducted March-May 2022) [@Sherman2022-hf].
