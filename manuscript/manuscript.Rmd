---
title: "A recipe for highly reproducible enrichment analysis (and why we need it)"
date: "`r Sys.Date()`"
output:
  rmdformats::robobook:
  html_document:
...
To help combat such issues, we provide a detailed beginner-friendly enrichment analysis protocol
...
Finally, we discuss how web-based tools without long-term preservation features might inadvertently put
researchers in breach of their data retention mandates.
...
Lastly, reanalysis can be made as simple as possible by creating a "main" script that executes analysis
...
framework has been described as a way of achieving a high degree of reproducibility @Ziemann2023-dg.
...
We are concerned about the validity of published enrichment analyses, as web-based and
...
One potential solution to this is to use containerisation to provide a complete scripted workflow with prescribed
...
We address this firstly by providing working example templates for Docker image and R Markdown scripts for
