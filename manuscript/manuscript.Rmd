---
title: "Tackling irreproducible enrichment analysis"
date: "`r Sys.Date()`"
output:
  rmdformats::robobook:
  html_document:
...
discrepancies, which we mainly ascribe to deficiencies in methodological reporting and lack of
preservation of past DAVID versions.
Better reporting and a long-term view of reproducibility are needed, which are satisfied with
scripted workflows and shared code.
...
The results show that poor reporting and lack of preservation of web-tools is to blame for poor
reproducibility.
There is a need to bring enrichment analysis in line with bioinformatics best practices, so
we present a beginner-friendly protocol that guides researchers through the process of
literate scripting, version control, containerisation, documentation and code/data sharing.
