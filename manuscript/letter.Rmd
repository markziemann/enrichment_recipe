---
title: "No publication without preservation: the argument against web-based tools in genomics"
date: "`r Sys.Date()`"
output:
  rmdformats::robobook:
  html_document:
...
Alt title: "Time to abandon (most) web-based tools in genomics"
...
We found only 3/20 enrichment studies had a high degree of reproduction, while 7/20 had severe discrepancies.
...
This was disturbing, as according to analysis of PubMed citations, some 20,000 articles citing DAVID enrichment tools will no longer be reproducible with
...
Therefore, we caution against using data from web-based tools for publication, unless there is a system in place to enable future reproducibility.
Scripted workflows are perhaps the most suitable solution for fostering long-term reproduction, but require expertise in computer programming.
...
In order to get genomics research to meet the ten-year reproducibility challenge [@Perkel2020-io], we need progress towards better tooling, a greater emphasis on investigator training, institutional support,
funder mandates, stronger publication criteria, and more incentives for rigourous and reliable practices [@Lewis2016-qh; @Diong2021-ma].
