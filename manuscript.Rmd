...
reproducible virtual machines or containers remains a miniscule fraction.
...
Web-based tools are a potential concern, algorithms and functional annotation sets undergo regular
updates, but the historical versions are typically not archived, nor are versions regularly reported
in publications, which hampers later reproducibility.
...
There are multiple barriers to entry for such workflows including (i) the added difficulty compares to
existing point-and-click solutions; (ii) time poorness of researchers to learn new skills; and (iii)
there is a lack of step-by-step guides, and few existing templates which can be rapidly adapted.
