...
Bar graph denoting the level of reproducibility of the 20 journal articles. 
  
While going through the papers a lot of discrepancies were observed. Out of the 20 journal articles that were analysed, 
thirty five percent (35%) of the papers showed low levels of reproducibility, fifty percent (50%) of the papers showed 
medium level of reproducibility and only fifteen percent (15 %) of the papers showed a high degree of reproducibility of 
the DAVID analysis results. 
...
| 6. | PMC6444048	| The text under “Pathway analysis of SUVmax related genes” And Table 2 |	1. Terms are the same but gene counts have been different. The DAVID results are somewhat reproducible. 2. No |	1. Gene counts in the terms significantly enriched in the “process of cell division” and “nucleoplasm” has changed. 2. Only cell cycle is highly enriched in the replicated results, the claims of metabolic pathways and hypoxia signalling (through GSEA analysis) to be enriched are not accurate. The results claimed are somewhat similar. All the processes have different FDR values. | 3 |
