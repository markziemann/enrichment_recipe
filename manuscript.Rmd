...
multiple contributors, taking over some of the functions of a laboratory notebook for computer based
projects.
...
detail [5](Wijesooriya et al, 2022), we don't have empirical proof confirming irreproducibility.
Therefore before recommending or prescribing new workflows, it is necessary
...
We have provided to the community a step-by-step protocol for how to conduct an extremely reproducible
...
The Rmarkdown script called `example_workflow.Rmd` undertakes the transcriptome and enrichment analyses.
...
To reproduce this work is relatively quick and simple.
Installing Docker requires one command and takes about 1 min.
Pulling the image takes about 1 minute.
Launching a container takes a few seconds, and executing the Rmarkdown script takes 80 seconds.
