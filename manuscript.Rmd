...
Irreproducible research is a significant problem that wastes resources and undermines the public
perception of science.
Previous work has highlighted that published enrichment analyses frequently suffers from statistical
and reporting flaws.
...
facilitate extreme reproducibility.
...
differences in computing environments over time, and the availability of dependancies @Perkel2020-io.
...
@Stein2010-of; @Dudley2010-ua; @Sandve2013-lk; @Piccolo2016-ji; @Gruning2018-sg; @Lewis2016-qh;
@Da_Veiga_Leprevost2017-dw; @Pasquier2018-rt; @Kulkarni2018-km; @Hung2019-et; @Brito2020-ld;
@Piccolo2021-ud]
...
were present in 85% of enrichment analyses @Wijesooriya2022-li.
...
and/or badging of articles that comply with best practices @Kidwell2016-pm.
