...
reanalyse the dataset from raw data.
...
the 20 articles were classified based on the degree of reproducibility (Figure 2).
...
```{r,barchart,fig.width=6,fig.height=5,echo=FALSE,fig.cap = "Figure 2. Examining reproducibility in a sample of 20 journal articles."}
