...
Articles rated 1 showed overall poor reproducibility, for example most GO and/or KEGG terms did not
match upon reproduction, and the conclusions of the study were overall not supported.
Aticles were rated 2 when at least 50% of the terms are observed as significant after replication,
...
* table
  ...
  The following tables gives a summary of the replication results of the articles:
  
S.No. |	Pubmed ID	| Replication of (Table/Figure) | Replication was possible? 1. Were the terms the same as authors? 2. Were there other significant terms found which were not mentioned in the article? |	Summary | Replication Classified as 1, 2, 3 |
| --- | -------- | ---- | ---- | ---- | ---- |
