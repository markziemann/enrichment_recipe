...
plotEnrichment(upname, stat, gseaParam = 1, ticksSize = 0.2)

dnname <- head(fgsea_dn,1)$pathway
plotEnrichment(dnname, stat, gseaParam = 1, ticksSize = 0.2)
...
heatmap.2(rpm_up,scale="row",trace="none",margins=c(10,10),main=upname,ColSideColors=colsidecols)
heatmap.2(rpm_dn,scale="row",trace="none",margins=c(10,10),main=dnname,ColSideColors=colsidecols)
